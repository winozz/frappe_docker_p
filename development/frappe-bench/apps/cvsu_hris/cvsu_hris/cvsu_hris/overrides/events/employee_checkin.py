...
def add_log_based_on_employee_field(
    ...
    device_id=None,
    log_type=None,
    is_break=1, #added to include in sending a POST request to the API 20240729
	longitude=0,
	latitude=0,
	custom_remarks=None,
    ...
    doc.custom_is_break = is_break #added to include in sending a POST request to the API 20240729
